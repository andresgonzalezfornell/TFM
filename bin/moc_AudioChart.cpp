...
#include "../src/interface/AudioChart.h"
...
const QMetaObject AudioChart::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AudioChart.data,
      qt_meta_data_AudioChart,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AudioChart::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AudioChart.stringdata0))
        return static_cast<void*>(const_cast< AudioChart*>(this));
