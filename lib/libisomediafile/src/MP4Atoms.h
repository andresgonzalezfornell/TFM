...
typedef struct MP4MediaAtom
{
	...
	MP4Err (*addGroupDescription)(struct MP4MediaAtom *self, u32 groupType, MP4Handle description, u32 *index );
	MP4Err (*mapSamplestoGroup)(struct MP4MediaAtom *self, u32 groupType, u32 group_index, s32 sample_index, u32 count );
	MP4Err (*getSampleGroupMap)(struct MP4MediaAtom *self, u32 groupType, u32 sample_number, u32* group_index );
	MP4Err (*getGroupDescription)(struct MP4MediaAtom *self, u32 groupType, u32 index, MP4Handle description );
...
typedef struct MP4MediaInformationAtom
{
	...
	MP4Err (*addGroupDescription)(struct MP4MediaInformationAtom *self, u32 groupType, MP4Handle description, u32 *index );
...
#define COMMON_CHUNK_OFFSET_FIELDS \
	...
	MP4Err (*mdatMoved)(struct MP4ChunkOffsetAtom *self, u32 firstchunk, u32 lastchunk, u64 mdatBase, u64 mdatEnd, s32 mdatOffset ); \
	u32	entryCount;
...
typedef struct MP4SampleGroupDescriptionAtom
{
	...
	MP4Err (*addGroupDescription)( struct MP4SampleGroupDescriptionAtom *self, MP4Handle theDescription, u32* index );
	MP4Err (*getGroupDescription)( struct MP4SampleGroupDescriptionAtom *self, u32 index, MP4Handle theDescription );
...
typedef struct MP4SampletoGroupAtom
{
	...
	MP4Err (*mapSamplestoGroup)( struct MP4SampletoGroupAtom *self, u32 group_index, s32 sample_index, u32 count );
...
{
	MP4_FULL_ATOM
	MP4Err (*addMetaItemExtentReference)( struct ISOMetaAtom *self, u32 item_ID, u64 dataOffset, MP4Handle sizesH );
